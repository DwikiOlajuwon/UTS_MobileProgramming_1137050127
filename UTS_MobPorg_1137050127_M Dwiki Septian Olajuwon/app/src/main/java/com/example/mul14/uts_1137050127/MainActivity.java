package com.example.mul14.uts_1137050127;
...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Pil = new String[] {"Cake Wedding", "Cake Happy BirthDay", "Cake Deadpool", "Cake Cool"};
        Gbr = new String[] {
                Integer.toString(R.drawable.coklatwedding),
                Integer.toString(R.drawable.cokelathbd),
                Integer.toString(R.drawable.deadpool),
                Integer.toString(R.drawable.cakecool),};
